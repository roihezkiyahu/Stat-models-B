...
author: "roi hezkiyahu and dov tuch"
date: "24 2 2022"
...
```{r}
glue("we can see that the pvalues are rather close")
t_statistic <- t_test$statistic
F_statistic <- summary(aov_pos)[[1]][["F value"]][1]
glue("we can also see that t_statistic^2:{round(t_statistic^2,4)} is around F_statistic:{round(F_statistic,4)}")
```
